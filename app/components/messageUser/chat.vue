...
<template>
    <article @mouseenter="isActiveUser ? isHover = true : isHover = false" @mouseleave="isHover = false"
        ...
        <section
            :class='{ "w-fit flex p-4 rounded-xl bg-body-900 flex-row-reverse gap-5 relative box-border": isActiveUser, "w-fit p-4 rounded-xl relative  bg-body-900 flex flex-row gap-5  box-border ": !isActiveUser }'>
