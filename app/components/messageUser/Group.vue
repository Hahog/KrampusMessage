...
<template>
    <article @mouseenter="isActiveUser ? isHover = true : isHover = false" @mouseleave="isHover = false"
        ...
        <section
            ...
            <section
                class="flex max-w-100 relative mt-10 items-center bg-body-900 box-border break-all h-fit p-3 rounded-xl">
                ...
                <section v-if="isHover"
                    ...
                    <svg @click.stop="$emit('editMessage', messageData.id)" class="fill-white" width="25px"
