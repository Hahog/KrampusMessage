...
<template>
    <ModalCreateGroup @createGroup="async (nameGroup: string) => {await groupClass.createGroup(nameGroup)}" @dropDialog="activeCreateDialog = false" v-if="activeCreateDialog" />
